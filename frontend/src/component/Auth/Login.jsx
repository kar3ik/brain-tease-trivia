...
export const AuthLogin = () => {
    ...
    const handleTestCredentialsClick = () => {
        const token = loginHandler("anyname","anypassword");
        authDispatch({
            type: "TOKEN",
            payload: token
        })
            ...
            <div className="login-auth d-flex direction-column justify-center">
                ...
                <form onSubmit={handleLoginClick}>
                    <div className="form-container">
                        ...
                        <input value={username} className="form-input lh-ls" placeholder="anyname" onChange={handleUserNameChange}/>
                    </div>
                    <div className="form-container">
                        <label className="form-label">Password</label>
                        <input value={password} className="form-input lh-ls" placeholder="anypassword" onChange={handlePasswordChange}/>
                    </div>
                    <div className="cta">
